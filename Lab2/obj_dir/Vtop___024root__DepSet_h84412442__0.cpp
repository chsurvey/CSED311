...
void Vtop___024root___eval_triggers__act(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.__VactTriggered.set(1U, vlSelfRef.__Vtrigprevexpr___TOP__top__DOT__cpu__DOT__reg_file__DOT__rf__0.neq(vlSelfRef.top__DOT__cpu__DOT__reg_file__DOT__rf));
    vlSelfRef.__VactTriggered.set(2U, (vlSelfRef.top__DOT__cpu__DOT__alu_result 
