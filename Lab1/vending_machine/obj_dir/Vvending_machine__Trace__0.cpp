...
void Vvending_machine___024root__trace_chg_0_sub_0(Vvending_machine___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[0U]))) {
        ...
        bufp->chgIData(oldp+7,(vlSelfRef.vending_machine__DOT__calculate_current_state_module__DOT__i),32);
    }
    bufp->chgBit(oldp+8,(vlSelfRef.clk));
    bufp->chgBit(oldp+9,(vlSelfRef.reset_n));
    bufp->chgCData(oldp+10,(vlSelfRef.i_input_coin),3);
    bufp->chgCData(oldp+11,(vlSelfRef.i_select_item),4);
    bufp->chgBit(oldp+12,(vlSelfRef.i_trigger_return));
    bufp->chgCData(oldp+13,(vlSelfRef.o_available_item),4);
    bufp->chgCData(oldp+14,(vlSelfRef.o_output_item),4);
    bufp->chgCData(oldp+15,(vlSelfRef.o_return_coin),3);
    bufp->chgIData(oldp+16,(vlSelfRef.vending_machine__DOT__current_total),31);
    ...
    bufp->chgIData(oldp+19,(vlSelfRef.vending_machine__DOT__wait_time),32);
    bufp->chgBit(oldp+20,(vlSelfRef.vending_machine__DOT__check_time_and_coin_module__DOT__is_reset));
}
